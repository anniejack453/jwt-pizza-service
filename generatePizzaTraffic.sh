...
# Simulate a user requesting the menu every 30 seconds
while true; do
...
# Simulate a user with an invalid email and password every 125 seconds
while true; do
...
# Simulate a franchisee logging in every three minutes
while true; do
...
# Simulate a diner ordering a pizza every 120 seconds
while true; do
